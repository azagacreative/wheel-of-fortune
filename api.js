...
const mode = urlParams.get("login");

if (_GAME_DEVELOPEMENT_MODE) {
...
// THIS METHOD NOT ABLE IN PRODUCTION
if (mode != "0") {
  ...
  $(document).ready(function () {
    $("#btn-register").click(function () {
      ...
      if (nickname != "") {
                ...
                success: function (data) {
                  if (data.status === 200) {
                    ...
                    Swal.fire({
                      ...
                      title: "Success",
                      html:
                        "You're registered!<br>Your nickname is: <b>" +
                        nickname +
                        "</b><br>Your pin code is: <b>" +
                        data.pin_code +
                        "</b>",
                    }).then((result) => {
        ...
        Swal.fire("Oops...", "Please enter the field!", "error");
      }
    });
  });
  $(document).ready(function () {
